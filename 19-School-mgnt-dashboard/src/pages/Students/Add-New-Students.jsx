  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Smart School | Add Students</title>
        </MetaTags>
        <Row>
              ...
              <Card className="mini-stat bg-white text-black ">
                <CardBody>
                  ...
                  <Row> 
                    ...
                    <AvField type="select" name="religion"  label="Select your Relion" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <AvField type="select" name="grade"  label="Select your grade" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <AvField type="select" name="birthCountry"  label="Select Country Of birth" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <Col xl={6} md={6}>
                      ...
                      <AvField
                          ...
                          validate={{ required: { value: true } }}
                      />
                          <AvField type="select" name="parentBirthCountry"  label="Select Country Of birth" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                              {
                                countrie_Arrays().map((country, key) => 
                                <option key={key}> {country} </option>
                                )
