        ...
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/teachers">{props.t("All Teachers")}</Link>
                </li>
                <li>
                  <Link to="/add-new-teachers">{props.t("Add New Teachers")} </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/#">{props.t("All Books")}</Link>
                </li>
                <li>
                  <Link to="/#">{props.t("Add New Books")}</Link>
                </li>
              </ul>
            </li>
