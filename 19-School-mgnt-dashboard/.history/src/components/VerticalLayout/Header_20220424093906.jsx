...
const Header = (props) => {
  ...
  document.addEventListener('click', function(e) {
    console.log(e);
    let body_Click = document.querySelector('.page-content');
    console.log(body_Click);
    if (window.screen.width <= 768) {
      body_Click.classList.ontoggle("sidebar-enable");
    } else {
      body_Click.classList.toggle("vertical-collpsed");
      body_Click.classList.toggle("sidebar-enable");
    }
  });
