                ...
                <CardBody>
                 <AvForm>
                  <Row> 
                    ...
                    <AvField type="select" name="gender" label="Select Gender"  validate={{ required: { value: true }}}>
                      <option>Male</option>
                      <option>Female</option>
                      <option>Others</option>
                    </AvField>

                    <AvField type="select" name="religion" label="Select your relion"  validate={{ required: { value: true }}}>
