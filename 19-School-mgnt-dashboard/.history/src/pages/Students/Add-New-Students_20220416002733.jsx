...
const AddNewStudents = () => {
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const { LastName, address, email, firstName, gender, number, religion, studenNumber, fileName } = std_Input;
    const inputata = { LastName, address, email, firstName, gender, number, religion, studenNumber, fileName };
    ...
    try {
     ...
     const res = await setDoc(doc(Db, "STUDENTS", rslt.user.uid), { 
      LastName, address, email, firstName, gender, number, religion, studenNumber, fileName,
