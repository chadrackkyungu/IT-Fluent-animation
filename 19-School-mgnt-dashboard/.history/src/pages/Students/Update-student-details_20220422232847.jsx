...
import {  doc, updateDoc, update, collection, getDocs, serverTimestamp } from 'firebase/firestore';
...
const AddNewStudents = () => {
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const allfield = {LastName, address, date_of_birth, email, firstName, gender, grade, number};

    try {
        const updateRes = doc(Db, "STUDENTS", id);
        await update(updateRes, {allfield});
