...
const AddNewStudents = () => {
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const userId = {LastName, address, date_of_birth, email, firstName, gender, grade, number, religion, studenNumber, img};
    console.log(userId);
    try {
        // const userId = auth.currentUser.allfield.uid;
        // console.log(userId);
        const updateRes = doc(Db, "STUDENTS",  userId.uid);
