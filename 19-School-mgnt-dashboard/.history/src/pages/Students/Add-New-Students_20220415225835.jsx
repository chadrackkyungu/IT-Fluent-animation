...
const AddNewStudents = () => {
  ...
  const handleValidSubmit = async(e, data) => {
    ...
    try {
      const rslt = await createUserWithEmailAndPassword(auth, data.email, data.password);
      
    //  const res = await addDoc(collection(Db, "STUDENTS"), { data});
     const res = await setDoc(doc(Db, "STUDENTS", rslt.user.uid), { data, timeStamp: serverTimestamp() });
