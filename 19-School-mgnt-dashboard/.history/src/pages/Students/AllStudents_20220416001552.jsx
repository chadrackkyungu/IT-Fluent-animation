...
const AllStudents = () => {
  ...
  const [dataDb, setData] = useEffect([]);
 ...
 const column = [
   ...
   {label: "Last Name",field: "team_name",sort: "asc",width: 150},
   {label: "Student number",field: "three_point_made_per_game",sort: "asc",width: 150},
   {label: "Email",field: "three_point_percentage",sort: "asc",width: 150},
   {label: "Phone Number",field: "team_acronym",sort: "asc",width: 150},
   {label: "Religion",field: "field_goal_percentage",sort: "asc",width: 150},
   {label: "Gender",field: "turnovers_per_game",sort: "asc",width: 150},
   {label: "Pic",field: "rebounds_per_game",sort: "asc",width: 150},
  ];
  ...
  const dat = [
    ...
    three_point_percentage: "33.3",
    turnovers_per_game: "0.3",
    clickEvent: () => handleClick(1) //* make sure to have this function inside your objects it for clicking event
  }
]
 ...
 const data = { 
  ...
  // * uncomment this to run the API
  //rows: player,  //Rows data that is coming form the Server(API) 
  rows: dat,  
 } 
