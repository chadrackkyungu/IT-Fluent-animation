...
import { serverTimestamp, doc, setDoc, updateDoc, collection, getDocs } from 'firebase/firestore';
              ...
              <Card className="mini-stat bg-white text-black ">
                <CardBody>
                  ...
                  <Row> 
                    ...
                    <Row>
                        <Col md={12}>
                        <img src={data.img ? data.img : fileName} className="rounded-circle avatar-lg" alt="" />
                        </Col>
                    </Row>
                    ...
                    <FormGroup className="mb-0">
                      <div className="d-flex p-2 text-center btn-mobile">
                        ...
                        <Button type="submit" color="primary" className="m-2 w-25 btn-mobile-width"  disabled={!data.img}>
                          Submit
                        </Button>
                      </div>
                    </FormGroup>
