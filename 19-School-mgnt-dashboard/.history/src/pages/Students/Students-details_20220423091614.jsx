      ...
      <Card>
        <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-center text-center m-4">
                    ...
                    <Button  className="btn bg-blue-700 waves-effect waves-light m-2" onClick={editStudent}> Update student details </Button>
                  ...
                  <CardBody>
                    ...
                    <div className="st-details-conatiner">
                      ...
                      <div className="prt-details-container">
                        <p> {` ${dataDb.parentName}  ${dataDb.parentLastName}`}</p> 
                        <p> {dataDb.CellNumber}</p> 
                        <p> {dataDb.parentEmail}</p> 
                      </div>
