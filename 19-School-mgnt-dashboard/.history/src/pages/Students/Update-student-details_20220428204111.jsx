  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <MetaTags>
          <title>Smart School | Update Student </title>
        </MetaTags>
        <Row>
          <Breadcrumb breadcrumbItem="Dashboard" title="Update Students" />
        </Row>
              ...
              <Card className="mini-stat bg-white text-black ">
                ...
                <CardBody>
                  ...
                  <Row> 
                    ...
                    <AvField value={data.religion} type="select" name="religion"  label="Select your Relion" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <AvField value={data.grade} type="select" name="grade" label="Select your grade" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <AvField value={data.birthCountry} type="select" name="birthCountry"  label="Select Country Of birth" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                    {
                    ...
                    <Col xl={6} md={6}>
                      ...
                      value={data.jobTitle}
                          ...
                          validate={{ required: { value: true } }}
                      />
                          <AvField value={data.parentBirthCountry}  type="select" name="parentBirthCountry"  label="Select Country Of birth" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
                              {
                                countrie_Arrays().map((country, key) => 
                                <option key={key}> {country} </option>
                                )
                    ...
                    <FormGroup className="mb-0">
                      <div className="d-flex justify-content-center p-2 text-center">
                        <Button type="submit" color="primary" className="m-2 bg-green-700 border-0 btn-mobile-width">
