...
import { grade_Arrays } from "../ARRAYS-AND-OBJECTS/Garde-Arrays";



const AddNewStudents = () => {

  const countries = countrie_Arrays();
  const grades = grade_Arrays();
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const allfield = {LastName, address, date_of_birth, email, firstName, gender, grade, number, religion, studenNumber, img,  timeStamp: serverTimestamp()};
              ...
              <Card className="mini-stat bg-white text-black ">
                ...
                <CardBody>
                  ...
                  <Row> 
                    ...
                    <AvField type="select" name="birthCountry" placeholder="Birth country" label="Select Country Of birth" className="mb-3 p-3 bg-white"  validate={{ required: { value: true }}}>
                    {
