...
//arrays
import  { countrie_Arrays } from './Arrays-countries.jsx';
...
{ countries.map((country, key) => {
   <AvField key={key} type="select" name="birthCountry" placeholder="Birth country" label="select your country of birht" className="mb-3 p-3 bg-white"  validate={{ required: { value: true }}}>
