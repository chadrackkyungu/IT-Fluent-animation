      ...
      <Card>
        <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-center text-center m-4">
                    ...
                    <Button  className="btn bg-blue-700 waves-effect waves-light m-2" onClick={editStudent}>Edit student </Button>
        ...
        <Row className="d-flex justify-content-around align-items-center  mobile-form-padding">
                <Col xl={6} md={6}>
                   ...
                   <CardImg className="img-fluid hide-mobile" src={dataDb.img} alt="smart-school" />
                   {/* <img className="show-mobile" src={dataDb.img} alt="smart-school" /> */}
                   </CardBody>
                </Col>
