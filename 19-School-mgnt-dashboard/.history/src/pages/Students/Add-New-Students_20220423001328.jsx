              ...
              <Card className="mini-stat bg-white text-black ">
                ...
                <CardBody>
                  ...
                  <Row> 
                    ...
                    <AvField type="select" name="birthCountry" placeholder="Birth country" label="select your country of birht" className="mb-3 p-3 bg-white"  validate={{ required: { value: true }}}>
                    {
