      ...
      <div className="page-content">
        ...
        <div className="d-flex justify-content-between align-items-center">
                ...
                <div className="btn-center text-center m-4">
                    <Button  className="btn bg-pink-700 waves-effect waves-light m-2 border-0"> Update student details </Button>
                </div>
        </div>
       </Card>
                  ...
                  <Row> 
                    ...
                    <FormGroup className="mb-0">
                      <div className="d-flex justify-content-center p-2 text-center">
                        <Button type="submit" color="primary" className="m-2 w-25">
                          Submit
                        </Button>
                      </div>
                    </FormGroup>
