 ...
 const data = { 
  ...
  return(
    <React.Fragment>
           ...
           <MetaTags >
          <title>Smart School | All Students </title>
          </MetaTags>
             <Row>
               ...
               " title="All Students" />
                ...
                <div className="btn-center text-right mt-4 mb-4">
                    <Link to="/new-student"  className="btn  waves-effect waves-light text-center red-500 shadow-sm  bg-white rounded">
                      Add New Student 
                    </Link>
                </div>
           ...
           <Col className="col-12">
             <Card>
               <CardBody>
                 ...
                 {/* <MDBDataTableV5 entries={10} entriesOptions={[10, 20, 30, 50]} responsive bordered striped hover  data={data} fullPagination 
                 />             */}
               </CardBody>
             </Card>
           </Col>
