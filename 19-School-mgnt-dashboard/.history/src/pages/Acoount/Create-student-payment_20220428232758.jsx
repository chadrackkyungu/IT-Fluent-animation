              ...
              <Col md={6}> 
                  ...
                  <AvField
                    ...
                    />
                       ...
                       <AvField type="select" name="status___" label="Select Status" className="mb-3 p-2 bg-white input-style"   errorMessage="please select payment method"  validate={{ required: { value: true }}}>
                  <option></option>
                  <option>CASH</option>
                  <option>EFT</option>
              </AvField>
