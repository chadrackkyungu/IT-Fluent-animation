...
function UpdatePayement() {
 ...
 useEffect(() =>{
  ...
  const deleteStudent = async() => {
    try {
      await deleteDoc(doc(Db, "PAYMENTS", data.id));
      successTost();
      history.push(`/all-fees-collection`);
    }catch(err){
  ...
  return (
    ...
    <div className="page-content">
      ...
      <Row>
        <Breadcrumb breadcrumbItem="Dashboard" title="Update Payment / Delete" />
      </Row>

      <div className="d-flex  align-items-center mb-4">
              <BackBtn url_Link="all-fees-collection" />
              <div className="btn-center text-center mr-4">
