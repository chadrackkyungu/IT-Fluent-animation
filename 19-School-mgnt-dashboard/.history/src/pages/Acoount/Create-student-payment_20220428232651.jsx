        ...
        <Card className="mini-stat bg-white text-black ">
          <CardBody>
            ...
            <Row> 
              ...
              <AvField type="select" name="status" label="Status" className="mb-3 p-2 bg-white input-style"   errorMessage="please select payment method"  validate={{ required: { value: true }}}>
                  <option></option>
                  <option>CASH</option>
                  <option>EFT</option>
              </AvField>
