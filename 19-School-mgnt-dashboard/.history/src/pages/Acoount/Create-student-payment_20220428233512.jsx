...
const CreateStudentsPayments = () => {
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const { ID_Number,Status,amount,date,name,payment_Method } = std_Input;
    const allfield = { ID_Number,Status,amount,date,name,payment_Method,  timeStamp: serverTimestamp()};
