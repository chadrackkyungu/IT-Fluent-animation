                  ...
                  <Col mg={6} lg={4}>
                      <Card key={i} className="rounded" data-aos="fade-up">
                          ...
                          <div className="image-container">
                            <img  className="img-fluid rounded-top" src={exam.urlImage} alt="smart-school-all subject" />
                          </div>

                        <CardBody>
                          <CardSubtitle className="h4 mt-0 ">{exam.subjectName}</CardSubtitle>
                          <CardText>
                            <h5 className="mt-3 mb-3"> Code : {exam.subjectCode}  ||  Type : {exam.type}</h5> 
                            <p> Grade : {exam.grade} </p> 
                          </CardText>
                          <div className="d-flex justify-content-between  btn-container">
                            <Link to={`/update-exam/${exam.id}`} className="btn bg-blue-400 waves-effect waves-light gray-100">Update</Link>
                          </div>
                        </CardBody>
                    </Card>
                  </Col>
