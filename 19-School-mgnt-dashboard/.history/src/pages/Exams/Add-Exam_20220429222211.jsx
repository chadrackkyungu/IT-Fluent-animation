...
const AddExams = () => {
  ...
  const handleValidSubmit = async(e, std_Input) => {
    ...
    const { EndTime,StartTime,exam,grade,section, semester,subjectName } = std_Input;
    const allfield = { EndTime,StartTime,exam,grade,section, semester,subjectName,  timeStamp: serverTimestamp()};
