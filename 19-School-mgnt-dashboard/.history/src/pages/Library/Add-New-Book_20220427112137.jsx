        ...
        <Card className="mini-stat bg-white text-black ">
          <CardBody>
            ...
            <Row> 
              ...
              />
              <AvField type="select" name="birthCountry"  label="Select Grade" className="mb-3 p-2 bg-white input-style"  validate={{ required: { value: true }}}>
              {
              ...
              />
                ...
                <Col xl={16} md={6}>
                  ...
                  <AvField 
                    className="mb-3 p-2 bg-white select-file input-style"                   
                    type="file"  
                    name="pic"
                    label="choose image"
