...
const handleValidSubmit = async(e, std_Input) => {
  ...
  const allfield = {TeacherName, TeacherLastName, TeacherIdNumber,date_of_birth,  email, number, gender, religion, address, bio ,birthCountry, img,selectedMulti,  timeStamp: serverTimestamp()};
  try {
