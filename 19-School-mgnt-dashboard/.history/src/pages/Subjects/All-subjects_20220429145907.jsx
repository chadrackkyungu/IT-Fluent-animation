                ...
                return(
                  <Col mg={6} lg={4}>
                      <Card key={i} className="rounded">
                        <CardImg top className="img-fluid" src={subject.img} alt="Card image cap" />
                        <CardBody>
                        <CardSubtitle className="h4 mt-0 rounded-top">{subject.subjectName}</CardSubtitle>
                        <CardText>
                          ...
                          <div className="d-flex justify-content-between  btn-container">
                            ...
                            <Link to="#"className=" btn-primary waves-effect waves-light">Delete</Link>
                          </div>
                        </CardBody>
                    </Card>
                  </Col>
